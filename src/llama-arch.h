...
enum llm_kv {
    ...
    LLM_KV_ROW4_SCHEMA_VERSION,
    LLM_KV_ROW4_WEIGHT_LAYOUT,
    LLM_KV_ROW4_EXECUTION_PROFILE,
    LLM_KV_ROW4_CODEBOOK,
    LLM_KV_ROW4_NUMERIC_PROFILE,
    LLM_KV_ROW4_QKV_ORDER,
    LLM_KV_ROW4_FFN_ORDER,
    LLM_KV_ROW4_LM_HEAD_LAYOUT,
...
enum llm_tensor {
    ...
    LLM_TENSOR_TOKEN_EMBD_IMAG,
    LLM_TENSOR_TOKEN_EMBD_REAL,
