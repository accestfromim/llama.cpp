...
void ggml_compute_forward_complex_rope(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_complex_rmsnorm(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_fairy2i_rms_norm_exact(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_fairy2i_silu_exact(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_fairy2i_mul_exact(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_fairy2i_pack_bf16_exact(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_fairy2i_attn_exact_cpu(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_fairy2i_rope_exact(const struct ggml_compute_params * params, struct ggml_tensor * dst);
...
void ggml_compute_forward_turbo_k_mean_center(const struct ggml_compute_params * params, struct ggml_tensor * dst);
