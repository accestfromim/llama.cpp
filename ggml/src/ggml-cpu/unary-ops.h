...
void ggml_compute_forward_complex_relu2(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_ifairy_relu2(const struct ggml_compute_params * params, struct ggml_tensor * dst);
