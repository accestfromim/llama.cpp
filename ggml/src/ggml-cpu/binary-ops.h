...
void ggml_compute_forward_complex_add(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_complex_mul(const struct ggml_compute_params * params, struct ggml_tensor * dst);
