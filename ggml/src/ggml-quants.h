...
GGML_API void quantize_row_ifairy64_ref(const float * GGML_RESTRICT    x_real,
                                        ...
                                        int64_t                        k);
GGML_API void quantize_row_fairy2i_tile64_v2_ref(const float * GGML_RESTRICT                x_real,
                                                 const float * GGML_RESTRICT                x_imag,
...
GGML_API void dequantize_row_ifairy64(const block_ifairy64 * GGML_RESTRICT x,
                                      ...
                                      float * GGML_RESTRICT                y_imag,
                                      int64_t                              k);
GGML_API void dequantize_row_fairy2i_tile64_v2(const block_fairy2i_tile64_v2 * GGML_RESTRICT x,
                                               float * GGML_RESTRICT                          y_real,
                                               float * GGML_RESTRICT                          y_imag,
                                               int64_t                                        k);
...
struct ggml_fairy2i_2w_index_info {
    int64_t k;
...
GGML_API bool   ggml_ifairy64_2w_encode(const block_ifairy64 * GGML_RESTRICT weights,
                                        ...
                                        uint8_t * GGML_RESTRICT              dst,
                                        size_t                               dst_size);
GGML_API struct ggml_fairy2i_2w_index_info ggml_fairy2i_tile64_2w_get_index_info(int64_t k);
GGML_API size_t ggml_fairy2i_tile64_2w_index_buffer_size(const struct ggml_fairy2i_2w_index_info * info,
                                                         int64_t                                    rows);
GGML_API bool   ggml_fairy2i_tile64_2w_encode(const block_fairy2i_tile64_v2 * GGML_RESTRICT weights,
                                              int64_t                                        k,
                                              int64_t                                        rows,
                                              uint8_t * GGML_RESTRICT                        dst,
                                              size_t                                         dst_size);
