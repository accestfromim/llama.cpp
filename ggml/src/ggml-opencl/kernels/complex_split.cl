...
kernel void kernel_complex_split(global char * src0,
                                ulong         offset0,
                                global char * dst,
                                ulong         offsetd,
                                int           n_dims,
    ...
    for (int i0 = get_local_id(0); i0 < n_dims; i0 += get_local_size(0)) {
        ...
        const float real_v = complex_bf16_to_f32((ushort) (v & 0xFFFFu));
        const float imag_v = complex_bf16_to_f32((ushort) (v >> 16));
