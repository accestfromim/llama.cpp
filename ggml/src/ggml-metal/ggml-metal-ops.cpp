...
int ggml_metal_op_fairy2i_wide_linear_w2(ggml_metal_op_t ctx, int idx) {
    ...
    if (act_rows != 1) {
        ...
        const char * pipeline_name = use_bundle_w1_mn ? "kernel_fairy2i_bundle_w1_half_mma16x32_k16" :
        ...
        const int row_tile = use_bundle_w1_mn ? 16 : 32;
        const int col_tile = use_bundle_w1_mn ? 32 : 16;
